					...
					<div class="content-wrapper">
						...
						<div class="outer-wrapper">
							<div class="button-wrapper flex gap-x-8">
								<div class="prev-button hidden absolute top-[24px] right-28 translate-y-1/4 cursor-pointer z-20">
								...
								<div class="next-button absolute top-[24px] right-24 translate-y-1/4 cursor-pointer z-20">
									<svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none" style="display: block;">
										<path d="M1.05033 1.05025L6.00008 6L1.05033 10.9497" stroke="white"/>
									</svg>
								</div>
								<div class="close-button absolute top-4 right-4 w-[32px] h-[32px] cursor-pointer flex justify-center items-center" style="background-color: #D75C00; border-radius: 50%;">
