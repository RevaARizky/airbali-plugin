...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var animateText = function animateText(el) {
      el.split = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_2__.SplitText(el, {
        type: 'lines',
        linesClass: 'split-line overflow-hidden'
      });
      el.anim = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
        paused: true
      });
    ...
    var imageSlider = document.querySelector('.carousel-block .image-slider-wrapper');
    var contentSlider = document.querySelector('.carousel-block .content-slider-wrapper');
    var titleSlider = document.querySelector('.carousel-block .title-slider-wrapper');
    var buttons = document.querySelector('.carousel-block .button-wrapper');
    var counter = document.querySelector('.carousel-block .counter-wrapper');
    contentSlider.querySelectorAll('.swiper-slide p').forEach(function (el) {
      animateText(el);
    });
    var opt = function opt(_opt) {
    ...
    var contentInit = function contentInit(e) {
      e.slides[e.activeIndex].querySelectorAll('p').forEach(function (p) {
        p.anim.play();
      });
    };
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](imageSlider, opt({
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade],
      effect: 'fade'
    }));
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](contentSlider, opt({
      on: {
        init: contentInit
      },
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade],
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](titleSlider, opt({
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade],
      effect: 'fade',
      fadeEffect: {
        crossFade: true
    ...
    contentSlider.swiper.on('slideChange', function (e) {
      counter.querySelector('.current-counter').innerHTML = "0".concat(e.activeIndex + 1);
      e.slides.forEach(function (el, i) {
...
/***/ "./src/scss/blocks/_text-hover.scss":
/*!******************************************!*\
  !*** ./src/scss/blocks/_text-hover.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/scss/blocks/_image-overlay.scss":
/*!*********************************************!*\
  !*** ./src/scss/blocks/_image-overlay.scss ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/scss/blocks/_map-control.scss":
/*!*******************************************!*\
  !*** ./src/scss/blocks/_map-control.scss ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/js/blocks/carousel.js")))
/******/ 	__webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/scss/blocks/_carousel.scss")))
/******/ 	__webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/scss/blocks/_gallery.scss")))
/******/ 	__webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/scss/blocks/_image-overlay.scss")))
/******/ 	__webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/scss/blocks/_itrac.scss")))
/******/ 	__webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/scss/blocks/_map-control.scss")))
/******/ 	__webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/scss/blocks/_slider.scss")))
/******/ 	__webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/scss/blocks/_team.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/_map-control","dist/css/_itrac","dist/css/_image-overlay","dist/css/_gallery","dist/css/_carousel","dist/css/_text-hover","dist/css/_team","dist/css/_slider"], () => (__webpack_require__("./src/scss/blocks/_text-hover.scss")))
