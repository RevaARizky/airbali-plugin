...
(function ($) {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].registerPlugin(gsap_SplitText__WEBPACK_IMPORTED_MODULE_2__["default"]);
    var popupSlider = mainel.querySelector('.popup-target .swiper');
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](popupSlider, {
      slidesPerView: 1,
      spaceBetween: 0
    });
    ...
    mainel.querySelector('.popup-target .next-button').addEventListener('click', function (e) {
      popupSlider.slideNext();
    });
    mainel.querySelector('.popup-target .overlay').addEventListener('click', function (e) {
      hidePopup();
    });
    mainel.querySelectorAll('.popup-target .close-button').forEach(function (el) {
      el.addEventListener('click', function (e) {
        hidePopup();
      });
    });
    popupSlider.on('activeIndexChange', function (slider) {
