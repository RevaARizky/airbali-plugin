...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger, gsap_all__WEBPACK_IMPORTED_MODULE_2__.ScrollToPlugin);
    ...
    var checkResize = function checkResize() {
      ...
      var sections = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(".slider-block .slide-item");
      sections.forEach(function (el, i) {
        el.label = tl.add("label".concat(i), el.clientWidth * i);
      });
      var threshold = 1 / sections.length;
      var activeBefore = 1;
      mm.add('(min-width: 1024px)', function () {
        window.gsapScroll = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(sections, {
          ...
          scrollTrigger: {
            ...
            onUpdate: function onUpdate(self) {
              ...
              document.querySelectorAll('.slider-block .navigation-slider .navigation').forEach(function (el) {
                el.classList.remove('active');
              });
              document.querySelector(".slider-block .navigation-slider .navigation[data-index=\"".concat(currentProgress, "\"]")).classList.add('active');
            }
          }
        });
      });
    ...
    checkResize();
    var navigations = document.querySelectorAll('.slider-block .navigation-slider .navigation');
    navigations.forEach(function (el, i) {
      el.addEventListener('click', function () {
        if (i + 1 == navigations.length) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(window, {
            scrollTo: window.gsapScroll.scrollTrigger.end
          });
        } else if (i == 0) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(window, {
            scrollTo: window.gsapScroll.scrollTrigger.start
          });
        } else {
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(window, {
            scrollTo: sliderWidth / 4 * i + i * calculateContainer + window.gsapScroll.scrollTrigger.start
          });
        }
      });
    });
    document.querySelectorAll('.slider-block .overlay-button-wrapper').forEach(function (el, i) {
      el.addEventListener('click', function () {
        if (document.querySelector(".slider-block .slide-item[data-overlay=\"".concat(el.dataset.target, "\"]")).classList.contains('active')) {
          document.querySelector(".slider-block .slide-item[data-overlay=\"".concat(el.dataset.target, "\"]")).classList.remove('active');
          return;
        }
        document.querySelector(".slider-block .slide-item[data-overlay=\"".concat(el.dataset.target, "\"]")).classList.add('active');
      });
    });
  });
})();
